...
class ANAFErrorAnswerTest extends TestCase
{
    ...
    {
        $answer = ANAFErrorAnswer::Create(self::VALID_INVOICE);
    ...
    {
        $answer = ANAFErrorAnswer::Create("Invalid XML");
        $this->assertFalse($answer->IsSuccess());
        $this->assertNotNull($answer->LastError);
